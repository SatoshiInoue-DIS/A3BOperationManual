...
param searchIndexName string = 'javatextindex'
...
param openAiTextEmbeddingAda002DeploymentName string = 'text-embedding-ada-002-deploy'
...
module backend 'core/host/appservice.bicep' = {
  ...
  params: {
    ...
    appSettings: {
      ...
      AZURE_OPENAI_TEXT_EMBEDDING_ADA_002_DEPLOYMENT: openAiTextEmbeddingAda002DeploymentName
...
module openAi 'core/ai/cognitiveservices.bicep' = {
  ...
  params: {
    ...
    deployments: [
      ...
      {
        name: openAiTextEmbeddingAda002DeploymentName
        model: {
          format: 'OpenAI'
...
output AZURE_OPENAI_TEXT_EMBEDDING_ADA_002_DEPLOYMENT string = openAiTextEmbeddingAda002DeploymentName
